...
`app/chart_series.py` before this port. v0.5.0's port-neutral spine is untouched
...
`feature: qt-port`, where § "v0.4.26 - the interface moves to Qt" → "Required
