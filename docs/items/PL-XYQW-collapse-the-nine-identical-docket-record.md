...
added: 2026-09-13
verify: uv run pytest subprojects/docket/tests/test_checks.py && grep -q 'def test_the_record_advisory_names_every_owed_item_once' subprojects/docket/tests/test_checks.py
---
