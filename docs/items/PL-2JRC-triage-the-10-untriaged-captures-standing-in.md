...
verify: ! grep -l '^status: untriaged' docs/items/PL-2JRC-*.md docs/items/PL-6SRZ-*.md docs/items/PL-H0CF-*.md docs/items/PL-M3X6-*.md docs/items/PL-M7W1-*.md docs/items/PL-P55F-*.md docs/items/PL-PBP5-*.md docs/items/PL-RFHH-*.md docs/items/PL-YZJD-*.md docs/items/PL-Z891-*.md
---
