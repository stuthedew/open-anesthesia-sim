...
touches: docs/items
added: 2026-09-20
payoff: takes the v0.5.0 gate off its last two entries reading as unstartable, so the beat stops reporting a gate that is two promotions from clear as stuck
...
enough.** These two *are* the remainder of the gate. While they read as blocked,
