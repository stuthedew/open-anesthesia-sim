...
verify: uv run pytest subprojects/docket/tests/test_roadmap.py && grep -q 'def test_the_train_resolves_the_position_once' subprojects/docket/tests/test_roadmap.py && ! grep -q 'supported = plan.beat' subprojects/docket/src/docket/release.py
---
