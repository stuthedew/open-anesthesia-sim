...
added: 2026-09-13
verify: grep -q '"/docs/maintainer.md"' .claude/rules/apparatus-standard.md && grep -q 'docs/maintainer.md' .claude/rules/expert-review.md && uv run pytest tests/unit/test_rules_paths_check.py
---
