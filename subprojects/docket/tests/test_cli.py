...
is affordable only because `conftest.py` keeps the developer's global git
configuration out of them: with it reaching in, a single `commit.gpgsign = true`
made every commit here cost about fifteen times as much, and the bill looked
