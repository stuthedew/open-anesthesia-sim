...
def test_one_time_constant_reaches_expected_fraction() -> None:
    ...
    tissue.advance(arterial_partial_pressure_fraction=1.0, simulation_step_s=tissue.time_constant_s)
...
def test_zero_flow_preserves_tissue_state() -> None:
    ...
    amount_change = tissue.advance(arterial_partial_pressure_fraction=1.0, simulation_step_s=60.0)
...
def test_washout_returns_agent_to_blood() -> None:
    ...
    amount_change = tissue.advance(arterial_partial_pressure_fraction=0.0, simulation_step_s=10.0)
...
def test_exact_update_is_independent_of_step_size() -> None:
    ...
    one_step.advance(arterial_partial_pressure_fraction=0.08, simulation_step_s=60.0)

    for _ in range(600):
        many_steps.advance(arterial_partial_pressure_fraction=0.08, simulation_step_s=0.1)
