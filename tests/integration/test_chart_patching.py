...
class _ReplayController:
    ...
    def snapshot(self) -> SimulationSnapshot:
        ...
        return SimulationSnapshot(
            ...
            inspired_partial_pressure_fraction=state[INSPIRED_FRACTION],
            alveolar_partial_pressure_fraction=state[ALVEOLAR_FRACTION],
            mixed_venous_partial_pressure_fraction=state[VENOUS_FRACTION],
